...
//                                     <select name="role" className="form-control text-center"
//                                             // value={this.state.role}
//                                             onChange={this.onChangeRating}>
//                                             <option value="1" class="col-sm-10" >1</option>
//                                             <option value="2" class="col-sm-10" >2</option>
//                                             <option value="3" class="col-sm-10" >3</option>
//                                             <option value="4" class="col-sm-10" >4</option>
//                                             <option value="5" class="col-sm-10" >5</option>
//                                         </select>
//                                         {/* <RadioGroup onChange={this.onChangeRating} horizontal>
//                                             <RadioButton value="1" >1</ReversedRadioButton>
